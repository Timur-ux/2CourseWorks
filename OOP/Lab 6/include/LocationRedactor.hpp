...
const std::map<std::string, Command> str2EnumCommand{
	{"add", Command::addMob},
	{"remove", Command::removeMob},
	{"print", Command::printMobs},
	{"move", Command::moveMob},
	{"start battle round", Command::startBattleRound},
	{"undo", Command::undo},
	{"serialize", Command::serializeMobs},
	{"deserialize", Command::deserializeMobs},
	{"print commands list", Command::printCommandList}
};
